...
class Desserts : AppCompatActivity() {
    ...
    private fun getAllRecipes() {
            if (Constants.isNetworkAvailable(this)) {
                ...
                val listCall: Call<RecipeResponse> = service.getRecipe(
                    Constants.APP_ID, Constants.APP_KEY, "public", dishType = "Desserts"
                )
    ...
    private fun setUpDataIntoRecyclerView(recipeList: List<Hits>) {
        ...
        binding.dessertsRv.layoutManager = GridLayoutManager(this, 2)
        binding.dessertsRv.adapter = itemAdapter
